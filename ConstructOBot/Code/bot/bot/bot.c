...
void angle_rotate(unsigned int Degrees)
{
	...
	ReqdShaftCount = (float) Degrees/ 4.090; //0.3779; //4.090; // division by resolution to get shaft count
...
void linear_distance_mm(unsigned int DistanceInMM)
{
	float ReqdShaftCount = 0;
	unsigned long int ReqdShaftCountInt = 0;
	ReqdShaftCount = DistanceInMM / 5.338; //0.3779; //5.338; // division by resolution to get shaft count
