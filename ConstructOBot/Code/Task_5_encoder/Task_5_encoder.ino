...
void forward_wls()
{
  ...
  while (flag==0){
    ...
    if (left_sensor > threshold and center_sensor < threshold and right_sensor > threshold){ //WhiteLine Follower
      ...
      while (flag == 0){
        ...
        if (left_sensor > threshold and center_sensor < threshold and right_sensor > threshold){ // x > threshold -< white
          ...
          _delay_ms(25);
                  ...
                  (left_sensor > threshold and center_sensor < threshold and right_sensor < threshold) || 
                  (left_sensor < threshold and center_sensor < threshold and right_sensor > threshold)){
          forward();
          delay(200);
          stop();
