...
def get_train_test_loader(data_dir,batch_size,augment,random_seed,test_size=0.1,shuffle=True,num_workers=4,pin_memory=False):
	...
	test_loader = torch.utils.data.DataLoader(test_dataset, batch_size=batch_size, sampler=valid_sampler,num_workers=num_workers, pin_memory=pin_memory,)
...
#The path for saving the model .pth file
path = "habitat.pth"
# save model
